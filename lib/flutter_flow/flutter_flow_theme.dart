...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF78CA92);
  late Color secondary = const Color(0xFF3B6448);
  late Color tertiary = const Color(0xFFD4D1D0);
  late Color alternate = const Color(0xE6F9F0F0);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF6F6F6);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF667AC9);
  late Color accent2 = const Color(0xFF323C63);
  late Color accent3 = const Color(0xFF96C970);
  late Color accent4 = const Color(0xFFB9A6A6);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF78CA92);
  late Color secondary = const Color(0xFF3B6448);
  late Color tertiary = const Color(0xFFCEB8B8);
  late Color alternate = const Color(0xB01B1919);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF95A1AC);
  late Color primaryBackground = const Color(0xFF0C0C10);
